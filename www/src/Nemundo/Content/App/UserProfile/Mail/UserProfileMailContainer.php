...
namespace Nemundo\Content\App\UserProfile\Mail;
...
class UserProfileMailContainer extends AbstractUserLoginMailContainer
{

    protected function loadMailContainer()
    {
        $this->subject = 'Nemundo Login';
    }

    public function getContent()
    {

        $userItem = new UserBuilder($this->userId);
        ...
        $site->addParameter(new SecureTokenUrlParameter($userItem->getUserRow()->secureToken));
