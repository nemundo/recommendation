...
class ContentAppApplicationCollection extends AbstractApplicationCollection
{
    ...
    protected function loadCollection()
    {
        ...
        $this
            ->addApplication(new WebCrawlerApplication())
            ->addApplication(new PodcastApplication())
