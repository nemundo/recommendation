...
use Nemundo\Content\App\Stream\Page\StreamAdminPage;
use Nemundo\Content\App\Stream\Page\StreamPage;
use Nemundo\Web\Site\AbstractSite;

class StreamAdminSite extends AbstractSite
{
    ...
    protected function loadSite()
    {
        ...
        $this->title = 'Stream';
        $this->url = 'stream-admin';
        StreamAdminSite::$site = $this;
